...
<title>Feedback Particular Merchant</title>
...
<!--Search Bar Ends Here-->      
           ...
           <!-- Logout Starts Here -->
	<div class="user">Welcome ${Customername }
...
<form action="addMerchantFeedback" method="get">
<table>
				<tr><td>Enter Feedback</td><td>	<textarea id="n8" name="n8" rows=10 cols=30></textarea></td></tr>	
				<tr><td>Enter Rating between 1 to 5</td><td><input type=text id="a1" name="a1" ></input></td></tr>
